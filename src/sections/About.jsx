...
export default function About() {
  ...
  return (
    <section id="about" className="w-full py-[120px] md:py-[180px] bg-[#f8fafc] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] text-[#0f172a] relative border-y border-[#e2e8f0]">
